...
public class World1 extends World{
    ...
    public void initializeEnemies(){
        ...
        scene.enemyList.add( new Skeleton1("Skeleton1", scene, (int) (screenSize.width * 0.65), (int)(screenSize.height * 0.22), screenSize.width * 0.4, screenSize.width * 0.8, 7, 8, protag));
