 ...
 * @author zendy
 */
public class MiniBoss1 implements MouseInteractable, Entity {
    ...
    public MiniBoss1(String characterType, SceneBuilder panel, int posX, int posY) {
        this.posY = posY;
        this.posX = posX;
    ...
    public void initializeIdleSprites(String assetPackage, int width, int height) {
        ...
        for (int i = 0; i < size; i++) {
            spritePaths[i] = "/" + assetPackage + "_assets/miniBossWorld1/sprite" + i + ".png";
        }
