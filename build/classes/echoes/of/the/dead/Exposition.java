package build.classes.echoes.of.the.dead;
...
public class Exposition {
    ...
    // Method to print the first text
    public void printText() {
        String x = "";
        for (int i = 0; i < arr.length; i++) {
            if (arr[i] != null && !x.equalsIgnoreCase("x")) { // replace code here with onScreen click function
